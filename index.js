...
var userName = "Ammar";
var message = `Hello ${userName},would u like to learn some typescipt today?`;
console.log(message);
//3. Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.
var personName = "Muddasar";
...
var authorName = "Emily Dickinson";
var quote = "A word is dead when it is said, Some say.I say it just begins to live that day";
...
let friendsName = ["kashif", "Ali", "Nasrullah", "Sohail"];
...
let friendsNameList = ["kashif", "Ali", "Nasrullah", "Sohail"];
...
let favouriteTrsnsport = ["train", "car", "Bike"];
...
let guestsList = ["kashif", "ali", "imran"];
...
let addGuestList = ["safdar", "mujahid", "mansha"];
//add in beginning
...
let placesToVisit = ["niagra fall", "shangila resort", "hunza", "nanga parbat", "medina"];
...
let cities = ["karachi", "lahore", "peshawar", "jhang", "faisalabad", "naran"];
...
let magicianNames = ["alex", "john doe", "Eric", "Peter"];
...
let magicianNames2 = ["alex", "john doe", "Eric", "Peter"];
